...
Best practive when processing imagery for Surface from Motion (SfM) is to carryout the least amount of post processing as possible. At a minimum only adjust Exposure and WB. Do not sharpen or adjust tone control. Only use Adobe Lightroom if you have no other options.
